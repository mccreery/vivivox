...
public class VivivoxMain {
	...
	public static void initOpenGL() {
		try {
			...
			crosshair = new Image("src/textures/crosshair.png");
	...
	public static void gameLoop() {
		...
		normal.init("src/shader.vert", "src/shader.frag");
		shaderProgram = normal.getProgramId();
		
		water = new ShaderProgram();
		water.init("src/underwaterShader.vert", "src/underwaterShader.frag");
